    ...
    <div className="Main">
      <section className="grid grid-2-columns">
        ...
        <div className="border-section">
          <h2>SKILLS</h2>
          <p>
            Under det senaste året har jag lärt mig HTML5, CSS, JS, React.js,
            Astro.js, responsiv webbutveckling, att göra API-calls, Git
            (terminal och GitDesktop), bitbucket, att host:a och integrera
            plug-ins. Jag kan bootstrap men föredrar Tailwindcss. Jag har också
            gjort en minikurs i AI och lärt mig grunderna i Figma. Håller på att
            lära mig allt om CMS (specifikt Sanity och Wordpress).
          </p>
          <div className="icons">
